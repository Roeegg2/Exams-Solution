...
in ((f 44) 33)"
	12)
      ...
      (map-example-1 "let lst = map proc (a) -(a, 2) [5, -(10, 2), 80] in -(listref(lst, 2), listref(lst, 0))" 75)

      (map-example-2 "let p = proc (a) -(a, 2) in listref(map p [5, -(10, 2), 80], 2)" 78)

      (testtest "let lst = map proc (a) -(a, 2) [5, 8, 80] in 8" 8)
      ))
  )
